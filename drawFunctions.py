...
def drawText(screen, trashCollection, my_font, width, height):
    ...
    if trashCollection[1].collected:
        ...
        img2.blit(bag, (0, 0))
        img2.blit(textBag, (90, 70))
        img2.blit(textBag1, (90, 120))
        img2.blit(textBag2, (90, 170))
        img2.blit(textBag3, (90, 220))
        img2.blit(textBag4, (90, 270))
        img2.blit(textBag5, (90, 320))
