...
def drawText(screen, trashCollection, my_font, width, height):
    ...
    textPlastic = my_font.render('Fishing nets lost at sea', False, (0, 0, 0))
    textPlastic1 = my_font.render('often get caught on animals', False, (0, 0, 0))
    textPlastic2 = my_font.render('in water, potentially injuring', False, (0, 0, 0))
    textPlastic3 = my_font.render('them and preventing mammals', False, (0, 0, 0))
    textPlastic4 = my_font.render('and birds from rising to the', False, (0, 0, 0))
    textPlastic5 = my_font.render('surface to breathe.', False, (0, 0, 0))
    ...
    if trashCollection[1].collected:
        ...
        img2.blit(bag, (0, 0))
        img2.blit(textBag, (80, 70))
        img2.blit(textBag1, (80, 120))
        img2.blit(textBag2, (80, 170))
        img2.blit(textBag3, (80, 220))
        img2.blit(textBag4, (80, 270))
        img2.blit(textBag5, (80, 320))
    if trashCollection[2].collected:
        img3 = Surface((1000, 1000)).convert_alpha()
        img3.fill((0, 0, 0, 0))
        img3.blit(unlocked, (0, 0))
        img3.blit(plastic, (0, 0))
        img3.blit(textPlastic, (70, 70))
        img3.blit(textPlastic1, (70, 120))
        img3.blit(textPlastic2, (70, 170))
        img3.blit(textPlastic3, (70, 220))
        img3.blit(textPlastic4, (70, 270))
        img3.blit(textPlastic5, (70, 320))
